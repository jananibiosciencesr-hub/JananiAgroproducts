  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full font-button text-sm font-semibold cursor-pointer transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        gold: "bg-brand-gold text-forest shadow-brand hover:-translate-y-0.5 hover:bg-brand-gold/90",
        glass: "border border-cream/30 bg-cream/80 text-primary shadow-soft backdrop-blur-md hover:bg-cream",
      },
      size: {
